...
const CandidateRegister = () => {
    ...
    const breadcrumbItems = [
        ...
        { name: `Add Candidate`, link: `/candidate`, active: true }
    ];
            ...
            <div className="main-content">
                <div className="page-content">
                    <div className="container-fluid">
                        <Breadcrumb title="Candidate Register" breadcrumbItems={breadcrumbItems} />
                        <div>
                        <ToastContainer/>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <p className='msgFile'>All Mandatory field *</p>
                        ...
                        <div className="col-md-2">
                                ...
                                <input type="date" className="form-control" id="dob" name="dob" value={dob} onChange={(e) => setDob(e.target.value)} required />
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                            <div className="form-group">
                            <label htmlFor="employeeCode" className="form-label">Select Gender *</label>
                        ...
                        <div className="d-inline-flex gap-1">
                            ...
                            <Link to={'/companies'}>
                                <button type="button" className="btn btn-outline-info">Company</button>
                            </Link>
                            {/* <Link to={'/bank'}>
