...
import {API_BASE_URL_COMPANY, API_EXCEL_URL, API_PDF_URL} from '../env';
...
const CompanyList = () => {
    ...
    const fetchCompanies = async () => {
        try {
            const response = await axios.get(API_BASE_URL_COMPANY + '/list');
            ...
            <div className='card'>
                ...
                <div className='card'>
                    <div className='card-header'>
                        <h4 className='card-title text-center'>Company List</h4>
                    </div>
                </div>
                    <div className="table-responsive">
                <div>
                    <Link to={'/addCompany'}>
                        <button type="button" className="btn btn-primary" style={{ marginLeft: '15px', margin: '10px' }}>Add Company</button>
                    </Link>
                    ...
                    <Link to={'/viewToDefaultSalary'}>
                         <button type="button" className="btn btn-warning" style={{ marginLeft: '15px', margin: '10px' }}>Default Salary</button>
                    </Link>

                    <Link to={'/viewToTaxSlab'}>
                    <button type="button"  className="btn btn-danger" style={{ marginLeft: '15px', margin: '10px' }}>Tax Slab</button>
                    </Link>
